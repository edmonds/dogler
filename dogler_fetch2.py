...
def extract_data(data):
    ...
    d['dsTable']    = extract_items(tree, xpath_dsTable, 10, 32)
    d['usTable']    = extract_items(tree, xpath_usTable, 6, 8)
    d['d31dsTable'] = extract_items(tree, xpath_d31dsTable, 11, 2)
    d['d31usTable'] = extract_items(tree, xpath_d31usTable, 6, 2)
    return d
